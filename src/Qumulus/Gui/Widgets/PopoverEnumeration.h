...
#ifndef GUI_WIDGETS_POPOVERENUMERATION_H_
#define GUI_WIDGETS_POPOVERENUMERATION_H_
...
class PopoverEnumeration : public QWidget, public PopoverForm {
public:
...
#endif /* GUI_WIDGETS_POPOVERENUMERATION_H_ */
